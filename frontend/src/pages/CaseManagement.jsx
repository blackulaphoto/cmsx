  ...
  const handleAddClient = async () => {
    ...
    try {
      ...
      const clientData = {
        ...
        intake_date: clientForm.intake_date,
        ...
        emergency_contact_relationship: clientForm.emergency_contact_relationship,
        ...
        housing_status: clientForm.housing_status,
        employment_status: clientForm.employment_status,
        benefits_status: clientForm.benefits_status,
        legal_status: clientForm.legal_status,
        program_type: clientForm.program_type,
        referral_source: clientForm.referral_source,
        prior_convictions: clientForm.prior_convictions,
        substance_abuse_history: clientForm.substance_abuse_history,
        mental_health_status: clientForm.mental_health_status,
        transportation: clientForm.transportation,
        medical_conditions: clientForm.medical_conditions,
        ...
        background: {
          addiction_recovery: clientForm.substance_abuse_history,
          housing_deadline: clientForm.housing_status,
          court_date: clientForm.legal_status,
          employment_history: clientForm.employment_status,
          current_benefits: clientForm.benefits_status,
          transportation: clientForm.transportation,
          challenges: clientForm.barriers,
        }
      }
                    ...
                    <div className="mt-4">
                      <DocumentationAssistPanel
                        ...
                        context={{
                          ...
                          referral_source: clientForm.referral_source,
                          program_type: clientForm.program_type,
                          observations: `Housing: ${clientForm.housing_status}; Employment: ${clientForm.employment_status}; Benefits: ${clientForm.benefits_status}; Legal: ${clientForm.legal_status}; Transportation: ${clientForm.transportation}`,
