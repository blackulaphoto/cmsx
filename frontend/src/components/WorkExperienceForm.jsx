...
import { Plus, Trash2, Calendar, Briefcase, Building } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <LocationSelector
                ...
                onChange={(nextValue) => updateExperience(index, 'location', nextValue)}
                placeholder="Search city or state"
                className="w-full"
                inputClassName="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
