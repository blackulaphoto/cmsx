...
const HOUSING = { path: '/housing', label: 'Housing & Placement', icon: MapPin, gradient: 'from-blue-500 to-cyan-500' };
...
const UR = { path: '/ur', label: 'Auth / UR', icon: Bell, gradient: 'from-amber-500 to-orange-500' };
